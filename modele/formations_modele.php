...
<h1>Diplômes</h1>
<button type="button" class="collapsible">Développeur Web/Web mobile</button>
<div class="content">
...
<button type="button" class="collapsible">Formation TAI</button>
<div class="content">
...
<button type="button" class="collapsible">Titre Professionnel TSSR(niveau V)</button>
<div class="content">
